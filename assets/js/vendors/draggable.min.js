...
$(document).ready((function () {
    dragula([document.getElementById("new")]), dragula([document.getElementById("qualified")]), dragula([document.getElementById("proposition")]), dragula([document.getElementById("won")]).on("drag", (function (e) {
        e.className = e.className.replace("card-moved", "")
    })).on("drop", (function (el) {
        e.className += " card-moved"
    })).on("over", (function (e, t) {
